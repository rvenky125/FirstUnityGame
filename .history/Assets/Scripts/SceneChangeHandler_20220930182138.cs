...
public class SceneChangeHandler : MonoBehaviour
{
    ...
    void OnStart()
    {
        StartCoroutine(downloader.DownloadFile("http://localhost/bundledassets/environmentassets", "Environment"));
    }
    ...
    public void OnSceneChange()
    {
        ...
        if (dropdown.value == 0)
        {
            url = "http://localhost/bundledassets/environmentassets";
            name = "Environment";
        }
        ...
        dropdown.gameObject.SetActive(tr);
